...
function Awake(){
	windowRect1 = Rect (Screen.width/2-190,Screen.height/2-140,380,280);
...
{		
	...
	//Back to main menu
	if(GUI.Button(Rect(-60,Screen.height-60, 400, 70), "BACK")){
		showMenu=false;
	...
	if(quickplayMode){
		...
		if(!errorMessage || errorMessage==""){ //Hide windows on error
			windowRect1 = GUILayout.Window (0, windowRect1, listGUI, "AVAILABLE SERVERS");	
