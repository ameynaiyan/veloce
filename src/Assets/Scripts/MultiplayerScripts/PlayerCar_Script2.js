...
function OnGUI () {
	...
	GUI.skin=rpmskin;
	GUI.Label (Rect (Screen.width/2-80,350,200,150), (Mathf.Abs(Mathf.Floor(EngineRPM*3))).ToString());
	if(EngineRPM>=0)
	{
		GUI.Label (Rect (Screen.width/2-70,380,200,150), (CurrentGear+1).ToString());
	}
	else
	{
		GUI.Label (Rect (Screen.width/2-70,380,200,150), "R");
	}
}